                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <p style="margin:10px 0 10px 0;color:#565a5c;font-size:18px">Click link bellow or use Link to see your shared picture.</p>
                        </td>
                    </tr>
                    <tr></tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <a href="{{ $details['link'] }}" style="text-decoration:none;">
                                <strong style="color:#ffff;text-decoration:none;display:block;width: 13em;text-align:center;background:#47a2ea;padding:0.5em;font-size:20px;margin-left: 4em; ">Check Now</strong>
                            </a>
                        </td>
                    </tr>
                    <tr>
